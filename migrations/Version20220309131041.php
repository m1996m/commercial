 ...
 */
final class Version20220309131041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD delete_at DATETIME DEFAULT NULL, ADD image_principal VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP delete_at, DROP image_principal, CHANGE designation designation VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE domaine domaine VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
